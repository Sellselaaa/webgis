<?php
    ...
    if ( !empty($_POST))
    {
        ...
        $query = "Delete from datakecamatan where Id_kecamatan=$Id";
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Hapus Data Kecamatan</li>
            </ol>
        </div><!--/.row-->
...
<div class="container">
    <div class="row">
		...
		<form method="POST" action="hapuskecamatan.php">
			<input type="hidden" name="Id_kecamatan" value="<?php echo $Id;?>" />
			<p class="bg-danger" style="padding: 10px;">Apakah anda ingin menghapus data ini?</p>
			<div class="form-actions">
				<button type="submit" class="btn btn-danger">Ya</button>
				<a class="btn btn btn-default" href="tabelkecamatan.php">Tidak</a>
			</div>
		</form>
